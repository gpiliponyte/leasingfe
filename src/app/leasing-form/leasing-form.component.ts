  ...
  ngOnInit() {
    ...
    this.leaseForm = new FormGroup({
      ...
      'advancePaymentPercentage': new FormControl(10,
        [Validators.required, Validators.pattern(this.numberRegex), Validators.max(100), Validators.maxLength(5),
          Validators.min(10)]),
  ...
  onChanges() {
    this.leaseForm.get('advancePaymentPercentage').valueChanges.subscribe(val => {
      ...
      if (this.leaseForm.get('advancePaymentPercentage').valid) {
        ...
        this.leaseForm.get('advancePaymentAmount').patchValue(this.value);
      } else {
    ...
    this.leaseForm.get('assetPrice').valueChanges.subscribe(val => {
      ...
      if (this.leaseForm.get('assetPrice').valid) {
        this.leaseForm.get('advancePaymentAmount').patchValue(val * (this.leaseForm.get('advancePaymentPercentage').value / 100));
      } else {
