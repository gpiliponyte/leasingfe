...
export class LeasingFormComponent implements OnInit {
  ...
  @ViewChild('f') leasingForm: NgForm;
  ...
  ngOnInit() {
    ...
    this.makes = Array.from( new Set(temp));
  ...
  onSubmit(){
    console.log(this.leasingForm);
    this.loan.customerType = this.leasingForm.value.customerType;
    this.loan.assetType = this.leasingForm.value.assetType;
    this.loan.make = this.leasingForm.value.make;
    this.loan.model = this.leasingForm.value.model;
    this.loan.year = this.leasingForm.value.year;
    this.loan.enginePower = this.leasingForm.value.enginePower;
    this.loan.assetPrice = this.leasingForm.value.assetPrice;
    this.loan.advancePaymentPercentage = this.leasingForm.value.advancePaymentPercentage;
    this.loan.advancePaymentAmount = this.leasingForm.value.advancePaymentAmount;
    this.loan.leasePeriod = this.leasingForm.value.leasePeriod;
    this.loan.margin = this.leasingForm.value.margin;
    this.loan.contractFee = this.leasingForm.value.contractFee;
    this.loan.paymentDate = this.leasingForm.value.paymentDate;
