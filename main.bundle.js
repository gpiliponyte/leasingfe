...
var LeasingFormComponent = /** @class */ (function () {
    ...
    LeasingFormComponent.prototype.ngOnInit = function () {
        this.leaseForm = new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["b" /* FormGroup */]({
            ...
            'assetPrice': new __WEBPACK_IMPORTED_MODULE_1__angular_forms__["a" /* FormControl */](null, [__WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].required, __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].pattern(this.validationRegex),
                __WEBPACK_IMPORTED_MODULE_1__angular_forms__["e" /* Validators */].min(5000)]),
    ...
    LeasingFormComponent.prototype.onChanges = function () {
        var _this = this;
        this.leaseForm.get('advancePaymentPercentage').valueChanges.subscribe(function (val) {
            console.log(val);
            if (_this.leaseForm.get('advancePaymentPercentage').valid) {
                _this.value = _this.leaseForm.get('assetPrice').value * (parseFloat(val) / 100);
                console.log('parsed value :' + parseFloat(val));
                console.log(_this.leaseForm.get('assetPrice').value);
                console.log(_this.value);
                _this.leaseForm.get('advancePaymentAmount').patchValue(_this.value.toFixed(2));
            }
            else {
